...
/// Difficulty-selection menu shown before a Story Sprint starts.
class StorySprintMenu extends StatelessWidget {
                  ...
                  child: ConstrainedBox(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'Type sentences to sprint down the track — every finished sentence is another 100 m!',
                        ...
                        Text(
                          'Capitals and punctuation count, so watch that Shift key!',
                          style: GoogleFonts.nunito(
                            fontSize: 13,
                            fontWeight: FontWeight.w700,
                            color: _accent,
...
/// Results screen shown when a Story Sprint ends.
class StorySprintGameOver extends StatelessWidget {
  final int score;
